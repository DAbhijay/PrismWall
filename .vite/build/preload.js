...
contextBridge.exposeInMainWorld("prismAPI", {
  ...
  setSlot: (slot, filePath) => ipcRenderer.invoke("set-slot", slot, filePath),
  ...
  setXray: (config) => ipcRenderer.invoke("set-xray", config),
  // ── Spotify ────────────────────────────────────────────────────────────────
  connectSpotify: () => ipcRenderer.invoke("spotify-connect"),
  disconnectSpotify: () => ipcRenderer.invoke("spotify-disconnect"),
  setSpotifyClientId: (clientId) => ipcRenderer.invoke("spotify-set-client-id", clientId),
  // ── Settings ───────────────────────────────────────────────────────────────
  setKeybind: (keybind) => ipcRenderer.invoke("set-keybind", keybind),
  // ── Event listeners ────────────────────────────────────────────────────────
